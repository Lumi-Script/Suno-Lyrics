...
export const getSunoCredits = async (cookie: string): Promise<number> => {
    ...
    // Direct Suno billing endpoint or proxy
    const baseUrl = "/api";
    const BILLING_ENDPOINT = `${baseUrl}/billing/info/`;
...
export const getSunoFeed = async (
    ...
    const baseUrl = "/api";
    const FEED_ENDPOINT = `${baseUrl}/feed/v3`;
...
export const getLyricAlignment = async (songId: string, cookie: string): Promise<LyricAlignmentResponse> => {
    ...
    const baseUrl = "/api";
    const ENDPOINT = `${baseUrl}/gen/${songId}/aligned_lyrics/v2`;
...
export const getSunoClip = async (clipId: string, cookie: string): Promise<any> => {
    ...
    const baseUrl = "/api";
    const ENDPOINT = `${baseUrl}/clip/${clipId}`;
